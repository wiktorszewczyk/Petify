                        ...
                        <div className="filter-group">
                            ...
                            <div className="city-input-container">
                                <select
                                    value={filters.city}
                                    onChange={(e) => {
                                        const selected = majorPolishCities.find(
                    ...
                    <div className="card-container">
                        {currentAnimal ? (
                            <div
                                ...
                                onClick={
                                    !isDragging ? handleNextPhoto : undefined
                                }
                            ...
                            >
                                {!(
                                    showInfo &&
                                    currentPhotoIndex ===
                                        currentAnimal.photos.length - 1
                                ) ? (
                                    <>
                                        <img
                                            src={
                                                currentAnimal.photos[
                                                    currentPhotoIndex
                                                ]
                                            }
                                        ...
                                        <div className="basic-info">
                                            ...
                                            <p>
                                                {currentAnimal.shelterName}
                                                &nbsp;
                                                {currentAnimal.shelterAddress}
                                            </p>
                                        </div>
                                    ...
                                    <>
                                        ...
                                        >
                                            <div
                                                ...
                                                style={{
                                                    backgroundImage: `url(${currentAnimal.photos[currentPhotoIndex]})`,
                                                }}
                                            />
                            ...
                            <div className="no-animals">
                                <h2>
                                    Brak zwierząt spełniających podane filtry
                                </h2>
                                <p>
                                    Wróć za chwile może dodamy nowe zwierzaki!
                                </p>
                            </div>
                        )}
                    </div>
